...
## (surbrillance).
define gui.accent_color = u'#0d3ad6'
...
define gui.hover_color = u'#c203fc'
...
define gui.main_menu_background = im.Scale("images/mainmenu.png",1280,720)
define gui.game_menu_background = im.Scale("images/mainmenu.png",1280,720)
